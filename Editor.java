...
/**
 * Editor.java
 * Contains canvas and buttons for the creation of a
 * drawing canvas java applet
 *
 * @author edited by Azhar Hussain and Alec Cobban
 */
...
public class Editor extends JApplet {
    ...
    private final Color INITIAL_COLOR = Color.red; // default color starts as red
    private Color shapeColor = INITIAL_COLOR;
    ...
    public void init() {
        ...
        dwg = new Drawing(); // make an empty drawing
