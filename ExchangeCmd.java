...
public class ExchangeCmd extends Command {
     ...
     */
    public void executePress(Point p, Drawing dwg) {//Changed click to press to make this more responsive to mouse gestures
        ...
        if (s != null) { // was there a Shape containing p?
            ...
            else if (firstShape != null && firstShape != s){
